...
const ColorExplorer = () => {
  ...
  const getShapeClass = (shape) => {
    switch (shape) {
      case "方形指甲": return "square";
      case "方圓形指甲": return "square-round";
      case "圓形指甲": return "round";
      case "橢圓形指甲": return "oval";
      case "杏仁形指甲": return "almond";
      default: return "";
    }
  };
  ...
  return (
    <div className="color-explorer">
      <div className="card">
        ...
        {/* === Step 1: 膚色 === */}
        {step === 1 && (
          <div className="card-content fade-step">
          ...
          <div className="card-content fade-step">
            ...
            {selectedShape && (
              <div className="nail-preview">
                <p>甲片效果預覽：</p>
                <div className={`nail-shape ${getShapeClass(selectedShape)}`}></div>
              </div>
            )}
        ...
        {/* === Step 3: 款式 === */}
        {step === 3 && (
          <div className="card-content style-preview fade-step">
            <div className="progress-bar">
        ...
        {/* === Step 4: 結果 === */}
        {step === 4 && (
          <div className="card-content result-step fade-step">
